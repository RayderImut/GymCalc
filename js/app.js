const translations = {
  id: {
    ...
    summaryLabel: 'Kesimpulan',
    summaryNeedsAttentionTitle: 'Kurang sehat',
    summaryNeedsAttentionText: 'Hasil perhitungan menunjukkan beberapa angka berada di luar rentang ideal. Gunakan ini sebagai tanda untuk memperbaiki pola makan, latihan, dan istirahat secara bertahap.',
    summaryHealthyTitle: 'Sehat (normal)',
    summaryHealthyText: 'Hasil perhitungan berada di rentang yang cukup baik. Pertahankan rutinitas latihan, asupan nutrisi, dan kebiasaan tidur yang konsisten.',
    summaryFitTitle: 'Sangat sehat (fit)',
    summaryFitText: 'Hasil perhitungan menunjukkan komposisi tubuh yang sangat baik. Pertahankan progresmu dengan latihan terukur dan pemulihan yang cukup.',
  ...
  en: {
    ...
    summaryNeedsAttentionTitle: 'Needs attention',
    summaryNeedsAttentionText: 'The calculation shows some numbers outside the ideal range. Use this as a cue to improve nutrition, training, and recovery gradually.',
    summaryHealthyTitle: 'Healthy (normal)',
    summaryHealthyText: 'The calculation is within a good general range. Keep your training routine, nutrition, and sleep habits consistent.',
    summaryFitTitle: 'Very healthy (fit)',
    summaryFitText: 'The calculation shows a very good body composition. Keep the progress going with measured training and enough recovery.',
